...
public class EntryListData {
  ...
  **/
   ...
   * @return createdAt
  **/
  @ApiModelProperty(value = "The time at which this entry was created. Sent in [ISO 8601 Format](https://en.wikipedia.org/wiki/ISO_8601). For example: `YYYY-MM-DDThh:mm:ss.ssssssZ`")
