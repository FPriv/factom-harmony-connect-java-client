...
public class EntryData {
  ...
  **/
   ...
   * @return createdAt
  **/
  @ApiModelProperty(required = true, value = "The time when this entry was created. Sent in [ISO 8601 Format](https://en.wikipedia.org/wiki/ISO_8601). For example: `YYYY-MM-DDThh:mm:ss.ssssssZ`")
